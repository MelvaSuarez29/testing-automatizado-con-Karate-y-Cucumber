  ...
  Background:
    ...
    * url baseUrl
    ...
    Scenario: CRUD completo de una mascota
      ...
      When method post
      Then status 200
      #Verificar que la respuesta para usarlo en los siguientes pasos
      ...
      # ============ SEARCH =============
      # Buscar mascotas por sattus para verificar que la actualización se reflejó
      ...
      And match response == '#[]'
      #Verificar que todas las mascotas retornadas tiene el status esperado
